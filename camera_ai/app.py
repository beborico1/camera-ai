...
class App:
    ...
    def __init__(self, window=tk.Tk(), window_title="Vrip: clasificador de camara"):
    ...
    def init_gui(self):
        ...
        self.btn_toggleauto = tk.Button(self.window, text="Auto Prediccion", width=50, command=self.auto_predict_toggle)
        self.btn_toggleauto.pack(anchor=tk.CENTER, expand=True)

        self.classname_one = simpledialog.askstring("Clase Uno", "Ingresa el nombre de la primera clase:", parent=self.window)
        self.classname_two = simpledialog.askstring("Clase Dos", "Ingresa el nombre de la dos clase:", parent=self.window)
        ...
        self.btn_predict = tk.Button(self.window, text="Predecir", width=50, command=self.predict)
        self.btn_predict.pack(anchor=tk.CENTER, expand=True)

        self.btn_reset = tk.Button(self.window, text="Reiniciar", width=50, command=self.reset)
        self.btn_reset.pack(anchor=tk.CENTER, expand=True)

        self.class_label = tk.Label(self.window, text="CLASE")
    ...
    def reset(self):
        ...
        self.counters = [1, 1]
        self.model = model.Model()
        self.class_label.config(text="CLASE")
